...
# validation, model_to_device, print_network, 中断及恢复训练，保存和加载模型，对lr的操作
class BaseModel():
    """Base model."""

    def __init__(self, opt): #传参数，设置device和训练/推理状态
        self.opt = opt
    ...
    def get_bare_model(self, net): #得到未被并行封装的原始模型
    ...
    def reduce_loss_dict(self, loss_dict): # print item
        """reduce loss dict.
